...
class LogBug:
    ...
    def __init__(self):
        ...
        # log名称
        self.logname = os.path.join(self.logdir,time.strftime("%Y_%m_%d")+'bug'+'.log')
        # 创建logger
...
if __name__ == '__main__':
    ...
    username='ligege'
    password='haoshuai'
    logbug.debug('真理：%s,密码：%s'%(username,password))
    logbug.debug('真理：{0},密码：{1}'.format(username,password))